...
internal class EdgeEvent : LibGpiodProxyBase
{
    ...
    {
        var handle = CallLibgpiod(() => Interop.Libgpiod.gpiod_edge_event_copy(_handle));
    ...
    {
        return CallLibgpiod(() => Interop.Libgpiod.gpiod_edge_event_get_event_type(_handle));
    }
    ...
    {
        return CallLibgpiod(() => Interop.Libgpiod.gpiod_edge_event_get_timestamp_ns(_handle));
    }
    ...
    {
        return CallLibgpiod(() => Interop.Libgpiod.gpiod_edge_event_get_line_offset(_handle));
    }
    ...
    {
        return CallLibgpiod(() => Interop.Libgpiod.gpiod_edge_event_get_global_seqno(_handle));
    }
    ...
    {
        return CallLibgpiod(() => Interop.Libgpiod.gpiod_edge_event_get_line_seqno(_handle));
    }
