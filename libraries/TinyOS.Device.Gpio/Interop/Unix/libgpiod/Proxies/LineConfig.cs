...
internal class LineConfig : LibGpiodProxyBase
{
    ...
    public void Reset()
    {
        CallLibpiodLocked(() => Interop.Libgpiod.gpiod_line_config_reset(Handle));
    }
    ...
    {
        CallLibpiodLocked(() => Interop.Libgpiod.gpiod_line_config_add_line_settings(Handle, offsets.Convert(), offsets.Length, lineSettings.Handle));
    }
    ...
    {
        return CallLibgpiod(() => new LineSettings(Interop.Libgpiod.gpiod_line_config_get_line_settings(Handle, offset)));
    }
    ...
    public void SetOutputValues(IEnumerable<GpiodLineValue> values)
    {
        CallLibpiodLocked(() =>
        {
            ...
            int result = Interop.Libgpiod.gpiod_line_config_set_output_values(Handle, valArr, valArr.Length);
            if (result < 0)
            {
    ...
    {
        return CallLibgpiod(() => Interop.Libgpiod.gpiod_line_config_get_num_configured_offsets(Handle));
    }
    ...
    public IEnumerable<Offset> GetConfiguredOffsets()
    {
        return CallLibgpiod(() =>
        {
            ...
            int nStored = Interop.Libgpiod.gpiod_line_config_get_configured_offsets(Handle, configuredOffsets, configuredOffsets.Length);
