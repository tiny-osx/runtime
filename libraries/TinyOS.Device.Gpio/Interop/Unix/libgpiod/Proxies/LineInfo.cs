...
internal class LineInfo : LibGpiodProxyBase
{
    ...
    {
        var handle = CallLibgpiod(() => Interop.Libgpiod.gpiod_line_info_copy(_handle));
    ...
    {
        return CallLibgpiod(() => Interop.Libgpiod.gpiod_line_info_get_offset(_handle));
    }
    ...
    public string? GetName()
    {
        return CallLibgpiod(() =>
        {
            IntPtr namePtr = Interop.Libgpiod.gpiod_line_info_get_name(_handle);
    ...
    {
        return CallLibgpiod(() => Interop.Libgpiod.gpiod_line_info_is_used(_handle));
    }
    ...
    public string? GetConsumer()
    {
        return CallLibgpiod(() =>
        {
            IntPtr namePtr = Interop.Libgpiod.gpiod_line_info_get_consumer(_handle);
    ...
    {
        return CallLibgpiod(() => Interop.Libgpiod.gpiod_line_info_get_direction(_handle));
    }
    ...
    {
        return CallLibgpiod(() => Interop.Libgpiod.gpiod_line_info_get_edge_detection(_handle));
    }
    ...
    {
        return CallLibgpiod(() => Interop.Libgpiod.gpiod_line_info_get_bias(_handle));
    }
    ...
    {
        return CallLibgpiod(() => Interop.Libgpiod.gpiod_line_info_get_drive(_handle));
    }
    ...
    {
        return CallLibgpiod(() => Interop.Libgpiod.gpiod_line_info_is_active_low(_handle));
    }
    ...
    {
        return CallLibgpiod(() => Interop.Libgpiod.gpiod_line_info_is_debounced(_handle));
    }
    ...
    public TimeSpan GetDebouncePeriod()
    {
        return CallLibgpiod(() =>
        {
            ulong debouncePeriodMicroseconds = Interop.Libgpiod.gpiod_line_info_get_debounce_period_us(_handle);
    ...
    {
        return CallLibgpiod(() => Interop.Libgpiod.gpiod_line_info_get_event_clock(_handle));
    }
