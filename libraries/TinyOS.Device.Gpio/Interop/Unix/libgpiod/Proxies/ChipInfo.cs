...
internal class ChipInfo : LibGpiodProxyBase
{
    ...
    {
        return CallLibgpiod(() => Marshal.PtrToStringAuto(Interop.Libgpiod.gpiod_chip_info_get_name(_handle)) ??
    ...
    {
        return CallLibgpiod(() => Marshal.PtrToStringAuto(Interop.Libgpiod.gpiod_chip_info_get_label(_handle)) ??
    ...
    {
        return CallLibgpiod(() => Interop.Libgpiod.gpiod_chip_info_get_num_lines(_handle));
    }
