...
internal class Miscellaneous
{
    ...
    {
        return LibGpiodProxyBase.CallLibgpiod(() => Interop.Libgpiod.gpiod_is_gpiochip_device(Marshal.StringToHGlobalAuto(path)));
    }
    ...
    public static string GetApiVersion()
    {
        return LibGpiodProxyBase.CallLibgpiod(() =>
            Marshal.PtrToStringAuto(Interop.Libgpiod.gpiod_api_version()) ?? throw new GpiodException($"Could not get API version: {LastErr.GetMsg()}"));
    }
}
