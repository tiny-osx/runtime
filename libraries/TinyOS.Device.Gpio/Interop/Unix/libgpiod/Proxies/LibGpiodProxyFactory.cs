...
internal static class LibGpiodProxyFactory
{
    ...
    {
        var handle = LibGpiodProxyBase.CallLibgpiod(() => Interop.Libgpiod.gpiod_chip_open(Marshal.StringToHGlobalAuto(devicePath)));
    ...
    {
        var handle = LibGpiodProxyBase.CallLibgpiod(() => Interop.Libgpiod.gpiod_edge_event_buffer_new(capacity));
    ...
    {
        var handle = LibGpiodProxyBase.CallLibgpiod(Interop.Libgpiod.gpiod_line_config_new);
    ...
    {
        var handle = LibGpiodProxyBase.CallLibgpiod(Interop.Libgpiod.gpiod_line_settings_new);
    ...
    {
        var handle = LibGpiodProxyBase.CallLibgpiod(Interop.Libgpiod.gpiod_request_config_new);
