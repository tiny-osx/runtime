...
internal class Chip : LibGpiodProxyBase
{
    ...
    {
        return CallLibgpiod(() => Marshal.PtrToStringAuto(Interop.Libgpiod.gpiod_chip_get_path(_handle)) ??
    ...
    public ChipInfo GetInfo()
    {
        return CallLibgpiod(() =>
        {
            var chipInfoHandle = Interop.Libgpiod.gpiod_chip_get_info(_handle);
    ...
    public LineInfo GetLineInfo(Offset offset)
    {
        return CallLibgpiod(() =>
        {
            var lineInfoHandle = Interop.Libgpiod.gpiod_chip_get_line_info(_handle, offset);
    ...
    public LineInfo WatchLineInfo(Offset offset)
    {
        return CallLibgpiod(() =>
        {
            var lineInfoHandle = Interop.Libgpiod.gpiod_chip_watch_line_info(_handle, offset);
    ...
    public void UnWatchLineInfo(Offset offset)
    {
        CallLibpiodLocked(() =>
        {
            int result = Interop.Libgpiod.gpiod_chip_unwatch_line_info(_handle, offset);
            if (result < 0)
            {
    ...
    {
        return CallLibgpiod(() => Interop.Libgpiod.gpiod_chip_get_fd(_handle));
    }
    ...
    public int WaitInfoEvent(long timeoutNs)
    {
        return CallLibgpiod(() =>
        {
            int result = Interop.Libgpiod.gpiod_chip_wait_info_event(_handle, timeoutNs);
            if (result < 0)
            {
    ...
    public LineInfoEvent ReadInfoEvent()
    {
        return CallLibgpiod(() =>
        {
            var lineInfoEventHandle = Interop.Libgpiod.gpiod_chip_read_info_event(_handle);
    ...
    public int GetLineOffsetFromName(string name)
    {
        return CallLibgpiod(() =>
        {
            int result = Interop.Libgpiod.gpiod_chip_get_line_offset_from_name(_handle, name);
            if (result < 0)
            {
    ...
    public LineRequest RequestLines(RequestConfig requestConfig, LineConfig lineConfig)
    {
        ...
        {
            var lineRequestHandle = Interop.Libgpiod.gpiod_chip_request_lines(_handle, requestConfig.Handle, lineConfig.Handle);
