...
internal class LineRequest : LibGpiodProxyBase
{
    ...
    {
        return CallLibgpiod(() => Interop.Libgpiod.gpiod_line_request_get_num_requested_lines(_handle));
    }
    ...
    public IEnumerable<Offset> GetRequestedOffsets()
    {
        return CallLibgpiod(() =>
        {
            ...
            int nStored = Interop.Libgpiod.gpiod_line_request_get_requested_offsets(_handle, requestedOffsets, requestedOffsets.Length);
    ...
    {
        return CallLibgpiod(() => Interop.Libgpiod.gpiod_line_request_get_value(_handle, offset));
    }
    ...
    public IEnumerable<GpiodLineValue> GetValuesSubset(IEnumerable<Offset> offsets)
    {
        return CallLibgpiod(() =>
        {
            ...
            int result = Interop.Libgpiod.gpiod_line_request_get_values_subset(_handle, offsetValues.Length, offsetsArr, offsetValues);
            if (result < 0)
            {
    ...
    public IEnumerable<GpiodLineValue> GetValues()
    {
        return CallLibgpiod(() =>
        {
            ...
            int result = Interop.Libgpiod.gpiod_line_request_get_values(_handle, offsetValues);
            if (result < 0)
            {
    ...
    public void SetValue(Offset offset, GpiodLineValue value)
    {
        CallLibpiodLocked(() =>
        {
            int result = Interop.Libgpiod.gpiod_line_request_set_value(_handle, offset, value);
            if (result < 0)
            {
    ...
    public void SetValuesSubset(IEnumerable<(Offset _offset, GpiodLineValue _value)> valueByOffset)
    {
        CallLibpiodLocked(() =>
        {
            ...
            int result = Interop.Libgpiod.gpiod_line_request_set_values_subset(_handle, offsets.Length, offsets, values);
            if (result < 0)
            {
    ...
    public void SetValues(IEnumerable<GpiodLineValue> values)
    {
        CallLibpiodLocked(() =>
        {
            ...
            int result = Interop.Libgpiod.gpiod_line_request_set_values(_handle, valArr);
            if (result < 0)
            {
    ...
    public void ReconfigureLines(LineConfig lineConfig)
    {
        CallLibpiodLocked(() =>
        {
            int result = Interop.Libgpiod.gpiod_line_request_reconfigure_lines(_handle, lineConfig.Handle);
            if (result < 0)
            {
    ...
    {
        return CallLibgpiod(() => Interop.Libgpiod.gpiod_line_request_get_fd(_handle));
    }
    ...
    public int WaitEdgeEvents(TimeSpan? timeout = null, bool waitIndefinitely = false)
    {
        return CallLibgpiod(() =>
        {
            ...
            int result = Interop.Libgpiod.gpiod_line_request_wait_edge_events(_handle, timeoutNs);
            if (result < 0)
            {
    ...
    public int ReadEdgeEvents(EdgeEventBuffer edgeEventBuffer)
    {
        return CallLibgpiod(() =>
        {
            int nReadEvents = Interop.Libgpiod.gpiod_line_request_read_edge_events(_handle, edgeEventBuffer.Handle, edgeEventBuffer.Capacity);
            if (nReadEvents < 0)
            {
