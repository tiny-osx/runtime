...
internal class RequestConfig : LibGpiodProxyBase
{
    ...
    {
        CallLibgpiod(() => Interop.Libgpiod.gpiod_request_config_set_consumer(Handle, Marshal.StringToHGlobalAuto(consumer)));
    }
    ...
    public string GetConsumer()
    {
        return CallLibgpiod(() =>
        {
            IntPtr consumerPtr = Interop.Libgpiod.gpiod_request_config_get_consumer(Handle);
    ...
    public void SetEventBufferSize(int eventBufferSize)
    {
        CallLibpiodLocked(() =>
        {
            ...
            Interop.Libgpiod.gpiod_request_config_set_event_buffer_size(Handle, eventBufferSize);
        });
    }
    ...
    {
        return CallLibgpiod(() => Interop.Libgpiod.gpiod_request_config_get_event_buffer_size(Handle));
    }
