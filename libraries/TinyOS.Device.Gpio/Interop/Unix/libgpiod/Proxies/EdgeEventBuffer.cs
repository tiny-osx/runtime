...
internal class EdgeEventBuffer : LibGpiodProxyBase
{
    ...
    {
        return CallLibgpiod(() => Interop.Libgpiod.gpiod_edge_event_buffer_get_capacity(Handle));
    }
    ...
    public EdgeEvent GetEvent(ulong index)
    {
        return CallLibgpiod(() =>
        {
            using EdgeEventNotFreeable edgeEventHandle = Interop.Libgpiod.gpiod_edge_event_buffer_get_event(Handle, index);
            ...
            EdgeEventSafeHandle edgeEventCopyHandle = Interop.Libgpiod.gpiod_edge_event_copy(edgeEventHandle);
    ...
    {
        return CallLibgpiod(() => Interop.Libgpiod.gpiod_edge_event_buffer_get_num_events(Handle));
    }
