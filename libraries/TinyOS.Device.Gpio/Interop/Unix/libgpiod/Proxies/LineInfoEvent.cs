...
internal class LineInfoEvent : LibGpiodProxyBase
{
    ...
    {
        return CallLibgpiod(() => Interop.Libgpiod.gpiod_info_event_get_event_type(_handle));
    }
    ...
    {
        return CallLibgpiod(() => Interop.Libgpiod.gpiod_info_event_get_timestamp_ns(_handle));
    }
    ...
    public LineInfo GetLineInfo()
    {
        return CallLibgpiod(() =>
        {
            LineInfoSafeHandleNotFreeable lineInfoHandle = Interop.Libgpiod.gpiod_info_event_get_line_info(_handle);
            ...
            LineInfoSafeHandle lineInfoCopyHandle = Interop.Libgpiod.gpiod_line_info_copy(lineInfoHandle);
