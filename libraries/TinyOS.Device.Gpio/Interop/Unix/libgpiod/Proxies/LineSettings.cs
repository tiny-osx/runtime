...
internal class LineSettings : LibGpiodProxyBase
{
    ...
    {
        var handle = CallLibgpiod(() => Interop.Libgpiod.gpiod_line_settings_copy(Handle));
    ...
    public void Reset()
    {
        CallLibpiodLocked(() => Interop.Libgpiod.gpiod_line_settings_reset(Handle));
    }
    ...
    public void SetDirection(GpiodLineDirection lineDirection)
    {
        CallLibpiodLocked(() =>
        {
            int result = Interop.Libgpiod.gpiod_line_settings_set_direction(Handle, lineDirection);
            if (result < 0)
            {
    ...
    {
        return CallLibgpiod(() => Interop.Libgpiod.gpiod_line_settings_get_direction(Handle));
    }
    ...
    public void SetEdgeDetection(GpiodLineEdge edge)
    {
        CallLibpiodLocked(() =>
        {
            int result = Interop.Libgpiod.gpiod_line_settings_set_edge_detection(Handle, edge);
            if (result < 0)
            {
    ...
    {
        return CallLibgpiod(() => Interop.Libgpiod.gpiod_line_settings_get_edge_detection(Handle));
    }
    ...
    public void SetBias(GpiodLineBias bias)
    {
        CallLibpiodLocked(() =>
        {
            int result = Interop.Libgpiod.gpiod_line_settings_set_bias(Handle, bias);
            if (result < 0)
            {
    ...
    {
        return CallLibgpiod(() => Interop.Libgpiod.gpiod_line_settings_get_bias(Handle));
    }
    ...
    public void SetDrive(GpiodLineDrive drive)
    {
        CallLibpiodLocked(() =>
        {
            int result = Interop.Libgpiod.gpiod_line_settings_set_drive(Handle, drive);
            if (result < 0)
            {
    ...
    {
        return CallLibgpiod(() => Interop.Libgpiod.gpiod_line_settings_get_drive(Handle));
    }
    ...
    public void SetActiveLow(bool isActiveLow)
    {
        CallLibpiodLocked(() =>
        {
            int result = Interop.Libgpiod.gpiod_line_settings_set_active_low(Handle, isActiveLow);
            if (result < 0)
            {
    ...
    {
        return CallLibgpiod(() => Interop.Libgpiod.gpiod_line_settings_get_active_low(Handle));
    }
    ...
    {
        CallLibpiodLocked(() => Interop.Libgpiod.gpiod_line_settings_set_debounce_period_us(Handle, (ulong)(debouncePeriod.TotalMilliseconds * 1000)));
    }
    ...
    public TimeSpan GetDebouncePeriod()
    {
        return CallLibgpiod(() =>
        {
            ulong debouncePeriodUs = Interop.Libgpiod.gpiod_line_settings_get_debounce_period_us(Handle);
    ...
    public void SetEventClock(GpiodLineClock eventClock)
    {
        CallLibpiodLocked(() =>
        {
            int result = Interop.Libgpiod.gpiod_line_settings_set_event_clock(Handle, eventClock);
            if (result < 0)
            {
    ...
    {
        return CallLibgpiod(() => Interop.Libgpiod.gpiod_line_settings_get_event_clock(Handle));
    }
    ...
    public void SetOutputValue(GpiodLineValue lineValue)
    {
        CallLibpiodLocked(() =>
        {
            int result = Interop.Libgpiod.gpiod_line_settings_set_output_value(Handle, lineValue);
            if (result < 0)
            {
    ...
    {
        return CallLibgpiod(() => Interop.Libgpiod.gpiod_line_settings_get_output_value(Handle));
    }
