...
internal sealed class LibGpiodEventObserver : IDisposable
{
    ...
    /// <summary>
    /// Since <see cref="LibGpiodDriver.AddCallbackForPinValueChangedEvent"/> does not create new requests (only adjusts present requests)
